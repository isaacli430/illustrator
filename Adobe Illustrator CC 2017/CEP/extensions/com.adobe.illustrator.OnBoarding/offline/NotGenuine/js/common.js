...
function SendEvent(type, buttonName) {
                var internalEvent = new CSEvent("OnBoardingEvent", "APPLICATION");
                var dataMap = {
                                "Type" : "ReportInternalEvent",
                                "Data" : 
                                {
												"SMID" : SMID,
                                                "InternalEvent" : type + buttonName
                                }
                };
                internalEvent.data = JSON.stringify(dataMap);
                CSLibrary.dispatchEvent(internalEvent);
                console.log (internalEvent.data);
