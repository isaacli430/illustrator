    ...
    getLayerInfo: function () {
        try {
            ...
            var populateTextOptionsInLayerObject = function (layerObject, selection) {
                ...
                layerObject.text = $._ADBE_LIBS_CORE.shortenString(selection.contents);
                if (layerObject.text === "") {
                ...
                try {
                    ...
                    if (selection && selection.length > 0 && selection.characterAttributes && selection.characterAttributes.textFont) {
                        ...
                        layerObject.canAddTextAsset = false;
                    }
                } catch (ignore) {

                }
                /*  Removing support to add text assets
                    Remove the line below to start supporting text addition
                */
                layerObject.canAddTextAsset = false;
